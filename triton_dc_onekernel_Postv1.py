"""Single-kernel post-only DC attention v1.
...
- for D=128 and HPG=8/16, final AV can use a wide2 path that consumes one
...
class TritonDCOneKernel:
    """Post-only DC v1: delayed a_acc update and HPG=8/16 wide2 final AV."""
